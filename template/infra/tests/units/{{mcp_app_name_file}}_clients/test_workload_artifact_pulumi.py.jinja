...
from {{mcp_app_name}}_clients.workload_artifact_pulumi import (
...
class TestDeleteArtifact:
    def test_delete_artifact_calls_workload_client_delete(self) -> None:
        ...
        with (
            ...
            patch(
                "{{mcp_app_name}}_clients.workload_artifact_pulumi.WorkloadClient",
...
class TestWorkloadImageArtifactProvider:
    def test_create_returns_artifact_id(self) -> None:
        ...
        with (
            env(DATAROBOT_API_TOKEN="token"),
            patch(
                "{{mcp_app_name}}_clients.workload_artifact_pulumi.build_artifact_with_provided_dockerfile",
                return_value="art-1",
            ),
        ):
...
class TestWorkloadGeneratedImageArtifactProvider:
    def test_create_returns_artifact_id(self) -> None:
        ...
        with (
            env(DATAROBOT_API_TOKEN="token"),
            patch(
                "{{mcp_app_name}}_clients.workload_artifact_pulumi.build_artifact_with_generated_dockerfile",
