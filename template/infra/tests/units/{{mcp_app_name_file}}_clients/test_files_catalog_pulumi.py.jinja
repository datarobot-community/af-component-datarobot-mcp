...
from {{mcp_app_name}}_clients.files_catalog_pulumi import (
...
class TestFilesCatalogBundleProvider:
    ...
    def test_create_uploads_bundle_and_returns_catalog_ids(self) -> None:
        ...
        with (
            ...
            patch(
                "{{mcp_app_name}}_clients.files_catalog_pulumi.read_bundle_files",
                return_value=[("app.py", b"code")],
            ),
            patch("{{mcp_app_name}}_clients.files_catalog_pulumi.FilesApiClient") as client_cls,
        ):
    ...
    def test_delete_deletes_catalog_by_id(self) -> None:
        ...
        with (
            env(DATAROBOT_API_TOKEN="token"),
            patch(
                "{{mcp_app_name}}_clients.files_catalog_pulumi.FilesApiClient",
