...
@pytest.fixture
def lifecycle() -> RecipeServerLifecycle:
    """Create a RecipeServerLifecycle instance."""
    return RecipeServerLifecycle()


@pytest.mark.asyncio
async def test_init() -> None:
    """Test RecipeServerLifecycle initialization."""
    lifecycle = RecipeServerLifecycle()
...
async def test_pre_server_start(
    lifecycle: RecipeServerLifecycle, mock_mcp: MagicMock
) -> None:
