...
from app.base.core.mcp_instance import dr_core_mcp_tool
from app.base.core.memory_management import ToolContext, get_memory_manager
...
async def list_resources(
    agent_identifier: str, memory_storage_id: Optional[str] = None
) -> str:
    """
