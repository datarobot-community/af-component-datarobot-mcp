...
def filter_tools_by_tags(
    ...
    Args:
        ...
        match_all: If True, tool must have all specified tags. If False, tool must have at least one tag.
...
def get_tool_tags(tool: Union[Tool, MCPTool]) -> List[str]:
    """
...
def list_all_tags(tools: List[Union[Tool, MCPTool]]) -> List[str]:
    """
...
def get_tools_by_tag(
    tools: List[Union[Tool, MCPTool]], tag: str
) -> List[Union[Tool, MCPTool]]:
    """
