...
from app.base.core.mcp_instance import mcp, register_tools
...
class TestMCPRegisterToolsIntegration:
    ...
    The session is not initialized in this test because its a client session that uses stdio protocol.
    ...
    async def test_register_tools_basic(self) -> None:
        ...
        async def test_tool(ctx: Context[ServerSession, Dict[str, Any]]) -> str:
